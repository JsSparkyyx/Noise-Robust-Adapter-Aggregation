...
def init_parameters():
    ...
    parser.add_argument('--task', type=str, choices=['mnli','qnli','sst2','qqp','elementary_math_qa','tracking_shuffled_objects','cryptonite','intersect_geometry','list_functions'], default='mnli')
